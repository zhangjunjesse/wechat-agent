...
- **部分被 ADR-0036 取代（2026-09-18 已落地）**：工具面（delegate_task/list_tasks/
  task_status/retry_task 单发模型）退役，换成任务板五工具 + 依赖 + 认领 + 重启恢复；
  runner/结算/notified/ephemeral/受限工具集底座条款由本记录继续持有并被 ADR-0036 继承。
  提案与论证见 `DESIGN-agent-task-board.md`
