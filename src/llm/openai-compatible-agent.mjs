...
export class OpenAICompatibleAgent {
  ...
  #context
  #historyProvider
  constructor({ fetchImpl = globalThis.fetch, baseUrl = 'https://api.openai.com/v1', apiKey = process.env.OPENAI_API_KEY, model = 'gpt-4o-mini', contextProvider = null, historyProvider = null, sessionStore = null } = {}) {
